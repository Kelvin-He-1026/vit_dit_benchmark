"""The DiT models, their load caveats, and the prompt set, shared by every
script in dit/."""

# First, so HF_HUB_CACHE is set before huggingface_hub is imported below.
...
# COCO 2014 validation captions, one per line in test.txt.
PROMPT_DATASET = "byliutao/coco2014val_10k"


def load_prompts(n):
    prompt_file = hf_hub_download(
        repo_id=PROMPT_DATASET,
        repo_type="dataset",
        filename="test.txt",
